...
var mtCookieDomain = ".stage.hidden-champion.net";
var mtCookiePath = "/";
...
(function () {
  ...
  function _initializeVariables() {
    ...
    loadingIcon = "<img title='Loading...' src='http://stage.hidden-champion.net/CMS/mt/mt-static/images/indicator.white.gif' alt='Loading' />";
  ...
  function _updateComments() {
    ...
    jsonUrl = [
        "http://stage.hidden-champion.net/CMS/mt/mt-comments.cgi?__mode=comment_listing&direction=",
        direction,
        "&entry_id=",
        entryID,
        "&limit=",
